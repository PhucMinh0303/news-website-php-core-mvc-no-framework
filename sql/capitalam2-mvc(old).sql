...
-- Đổi tên user (MySQL 8+)
RENAME USER 'admin_tintuc'@'localhost' TO 'new_user'@'localhost';
-- Đổi password
ALTER USER 'new_user'@'localhost' IDENTIFIED BY 'NewPassword123!';

-- Tạo user mới
CREATE USER 'new_user'@'localhost' IDENTIFIED BY 'NewPassword123!';
GRANT ALL PRIVILEGES ON quanly_tintuc.* TO 'new_user'@'localhost';
FLUSH PRIVILEGES;

-- Sau đó có thể xóa user cũ
DROP USER 'admin_tintuc'@'localhost';
