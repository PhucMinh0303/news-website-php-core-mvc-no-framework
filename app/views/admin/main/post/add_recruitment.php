            ...
            <div class="add-container">
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                    ...
                    <div class="form-group">
                        ...
                        <select name="degree">
                            <option value="Toàn thời gian" <?php echo (($formData['degree'] ?? '') == 'Toàn thời gian') ? 'selected' : ''; ?>>
                                Toàn thời gian
                            </option>
                            <option value="Bán thời gian" <?php echo (($formData['degree'] ?? '') == 'Bán thời gian') ? 'selected' : ''; ?>>
                                Bán thời gian
                            </option>
                            <option value="Hợp đồng" <?php echo (($formData['degree'] ?? '') == 'Hợp đồng') ? 'selected' : ''; ?>>
                                Hợp đồng
                            </option>
